            ...
            <v-card width="2300" height="590" style="margin-bottom: 10px;">
              <v-toolbar color="#003D5B" theme="dark" style="padding: 10px 0 10px 0;">
                ...
                <v-toolbar-title class="text-h6" style="font-size: 24px;"> 
                  Survey Diagnosis
                  <v-toolbar-title class="text-subtitle-2"> Do you have any worry about your health? Let’s have a quick survey and see what you got!  </v-toolbar-title>
                </v-toolbar-title>
              </v-toolbar>
