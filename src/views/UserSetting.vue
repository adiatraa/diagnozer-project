              ...
              <v-card width="2300" height="590" style="margin-bottom: 10px;">
                <v-toolbar color="#003D5B" theme="dark" style="padding: 10px 0 10px 0;">
                  <template v-slot:prepend>
                    <i style="margin-left: 10px; font-size: 30px;"><font-awesome-icon :icon="['fas', 'gear']" /></i>
                  </template>
  
                  <v-toolbar-title class="text-h6" style="font-size: 24px;"> 
                    User Setting
                    <v-toolbar-title class="text-subtitle-2"> Lets organize your profile!  </v-toolbar-title>
                  </v-toolbar-title>
                </v-toolbar>
